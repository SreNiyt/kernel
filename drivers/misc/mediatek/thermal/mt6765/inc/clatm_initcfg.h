...
#define CLATM_INIT_CFG_0_TARGET_TJ              (82000)
#define CLATM_INIT_CFG_0_EXIT_POINT             (5000)
...
#define CLATM_INIT_CFG_1_MIN_CPU_PWR            (1000)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR            (3000)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR            (1000)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR            (2000)

#define CLATM_INIT_CFG_2_TARGET_TJ              (82000)
#define CLATM_INIT_CFG_2_EXIT_POINT             (5000)
...
#define CLATM_INIT_CFG_2_MIN_CPU_PWR            (1200)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR            (3960)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR            (1000)
